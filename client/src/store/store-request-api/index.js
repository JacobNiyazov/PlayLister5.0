...
export const getAllPublishedPlaylists = () => api.get(`/publishedplaylists`)
...
export const updatePlaylistListensById = (id, playlist) => {
    return api.put(`/playlistListens/${id}`, {
        // SPECIFY THE PAYLOAD
        playlist : playlist
    })
}
